...
1. [Readers](tour/methods/21-readers.html) — The `io.Reader` interface and how `Read` works
2. [Exercise: Readers](tour/methods/22-exercise-readers.html) — Implementing a Reader that emits data
3. [Exercise: rot13Reader](tour/methods/23-exercise-rot13reader.html) — Wrapping a Reader to transform data
